...
public interface IWorkoutTypeRepository
{
    ...
    public Task<WorkoutType> GetByIdAsync(int workoutTypeId, bool asNoTracking = false, CancellationToken token = default, params Expression<Func<WorkoutType, object>>[] includes);    
    ...
    public Task DeleteRangeAsync(List<WorkoutType> workoutTypes, CancellationToken token);
