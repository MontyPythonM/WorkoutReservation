...
try
{
    ...
    RecurringJob.AddOrUpdate<MediatorHangfireJobService>(job => 
        job.SendJob(new GenerateUpcomingWorkoutTimetableCommand { IsAutoGenerated = true }), 
        Cron.Weekly(DayOfWeek.Monday, 00, 01), TimeZoneInfo.Local);
