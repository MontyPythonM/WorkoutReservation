...
public class RepetitiveWorkoutController : ApiControllerBase
{
    ...
    public async Task<IActionResult> ForceGenerateNewUpcomingWeek(CancellationToken token)
    {
        return await SendAsync(new GenerateUpcomingWorkoutsCommand(IsAutoGenerated: false), token);
    }
}
